...
#
# OFF_NH2_N21_Definition.TextUtility
#
...
Definition["defaultEditAreas"] = "Combinations_OFF_NH2_N21"
...
Definition["wmoID"] = "FZNT32"        # WMO ID
Definition["pil"] = "OFFN21"          # product pil
...
Definition["textdbPil"] = "MIAOFFN21"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KNHCOFFN21"   # Product ID for transmitting to AWIPS WAN.
