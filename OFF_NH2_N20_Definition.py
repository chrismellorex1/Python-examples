...
#
# OFF_NH2_N20_Definition.TextUtility
#
...
Definition["defaultEditAreas"] = "Combinations_OFF_NH2_N20"
...
Definition["wmoID"] = "FZNT31"        # WMO ID
Definition["pil"] = "OFFN20"          # product pil
...
Definition["textdbPil"] = "MIAOFFN20"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KNHCOFFN20"   # Product ID for transmitting to AWIPS WAN.
