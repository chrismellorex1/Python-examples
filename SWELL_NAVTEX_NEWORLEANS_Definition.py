...
Definition['displayName'] = "NAVTEX_NEWORLEANS_SWELL"
...
Definition["defaultEditAreas"] = [
            ('NAV06A', "Northwest Gulf of Mexico"),
            ('NAV06B', "NORTH CENTRAL AND NE GULF OF MEXICO")
            ]
...
Definition["wmoID"] = "FZNT27"        # WMO ID
Definition["pil"] = "OFFN06"          # product pil
...
Definition["textdbPil"] = "MIAOFFN06"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KNHCOFFN06"   # Product ID for transmitting to AWIPS WAN.
Definition["outputFile"] =  "{prddir}/TEXT/OFFN06.txt"
...
Definition["prevProdPIL"] = "MIAOFFN06"
