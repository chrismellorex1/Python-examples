...
#            "Wind": 9,
            "Wind": {
                (0, 12): 10,
                (12, 25): 10, #CHANGED FROM 5 AFTER 3 HRLY GRID IMPLEMENTATION 12/1/15 ERA
                (25, 45): 10,
                (45, 70): 15,
                (70, 200): 20,
                "default": 5,
...
#            "Swell": 5,  # ft
 ...
 #           "Swell2": 5,  # ft
    ...
    def vector_dir_difference_dict(self, tree, node):
        ...
        # Units are degrees
        return {
            "Wind": 60, # degrees (Was 90 for TAFB) #CHANGED FROM 45 12/1/15 ERA
            "Swell": 60, # degrees
            "Swell2": 60, # degrees
            }
...
#                           self.weather_phrase,
                           ...
                           # commented out local effects - will not work with swell - CNJ/JL/ERA 08/11/15
