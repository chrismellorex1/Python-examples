...
#
# FWS_NH2_Definition.TextUtility
#
...
#----- WFO NH2 FWS Definition -----
# Definition Statements must start in column 1.

# REQUIRED CONFIGURATION ITEMS
Definition['displayName'] = "Marine spot forecast_FWS"
#Definition['displayName'] = "MarineSpotForecast" commented out 11/7/20 ERA
Definition["productName"] = "SPOT FORECAST"  # name of product
Definition["statePil"] = "MIA"       # State Pil ID

# Header configuration items
Definition["fullStationID"] = "KNHC"  # full station identifier (4letter)
Definition["wmoID"] = "FNUS72"        # WMO ID
Definition["pil"] = "FWSNHC"          # product pil
...
Definition["textdbPil"] = "MIAFWSNHC"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KNHCFWSNHC"   # Product ID for transmitting to AWIPS WAN.
...
Definition["stqPil"] = "STQNHC"   # STQ pil
...
Definition["outlookFile"]  =   "/data/local/OLKFWFMFL"
