...
Definition['displayName'] = "NAVTEX_SANJUAN_SWELL"
...
Definition["defaultEditAreas"] = [
            ('NAV05A', "SAN JUAN ATLANTIC WATERS"),
            ('NAV05B', "SAN JUAN CARIBBEAN WATERS")
            ]
...
Definition["wmoID"] = "FZNT26"        # WMO ID
Definition["pil"] = "OFFN05"          # product pil
...
Definition["textdbPil"] = "MIAOFFN05"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KNHCOFFN05"   # Product ID for transmitting to AWIPS WAN.
Definition["outputFile"] =  "{prddir}/TEXT/OFFN05.txt"
