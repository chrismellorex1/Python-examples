...
#**********************************************************************
    ...
    def _Text1(self):
        ...
        if self._definition["pil"] == "SPANT4":
            ...
            return "Pronostico PARA LAS AGUAS COSTA AFUERA EN EL GOLFO DE MEXICO\n\n" + \
...
##                          ],
            ...
            analysisList = [
                      ...
                      # dictionary module.
                          ("Wind", self.vectorMinMax, [6]), #changed from "self.vectorModeratedMinMax" era 3/19/18
        ...
        return { "type": "component",
                 ...
                 "analysisList": [
                      ...
                      # dictionary module.
                          ...
                          # changed analysis method to vectorMax to include all Swell pixels in zone 8/7/15 CNJ/JL
                          ("Swell", self.vectorMax, [12]),
                          ("Swell2", self.vectorMax, [12]),
                          #added below based on what MFL uses 07/10/14 -JL
                          #("WaveHeight", self.moderatedMax, [6]),
