...
VariableList = [
       ...
       #     ["0430 UTC","1030 UTC", "1630 UTC", "2230 UTC"]),
        ...
        (("Include Previous FAGX?", "includePrevDisc"), "Yes", "radio",
            ["Yes"]),
        ]

Definition['displayName'] = "AVIATION_FAGX"
#old zones
...
Definition["wmoID"] = "FAGX20"        # WMO ID
Definition["pil"] = "OFAGX"          # product pil
...
Definition["textdbPil"] = "MKCOFAGX"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KKCIOFAGX"   # Product ID for transmitting to AWIPS WAN.
