...
#
# FWFTable_NH2_NHC_Definition.TextUtility
#
...
Definition["defaultEditAreas"] = "Combinations_FWFTable_NH2_NHC"
Definition["mapNameForCombinations"] = "FireWxZones_NH2" # Map background for creating Combinations
...
Definition["pil"] = "FWFNHC"          # product pil
...
Definition["textdbPil"] = "MIAFWFNHC"       # Product ID for storing to AWIPS text database.
Definition["awipsWANPil"] = "KNHCFWFNHC"   # Product ID for transmitting to AWIPS WAN.
Definition["outputFile"] =  "{prddir}/TEXT/FWF_NHC.txt"
...
#Definition["summaryArea"] = "FireWxAOR_NH2_NHC"
